...
/**
 * Cancel Check Out File Request Class
 *
 * @author gkspencer
 */
public class CancelCheckOutFileRequest extends ClientAPIRequest {
     ...
     * Default constructor
     */
    public CancelCheckOutFileRequest() {
    }
    ...
    public ApiRequest isType() {
        return ApiRequest.CancelCheckOut;
    }
