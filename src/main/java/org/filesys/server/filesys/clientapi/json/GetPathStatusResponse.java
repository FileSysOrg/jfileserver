...
/**
 * Get Path Status Client API Response Class
 *
 * @author gkspencer
 */
public class GetPathStatusResponse extends ClientAPIResponse {

    @SerializedName( value = "status_list")
    private List<PathStatusInfo> m_stsList;

    /**
     * Class constructor
     *
     * @param stsList List&lt;PathStatusInfo&gt;
     */
    public GetPathStatusResponse( List<PathStatusInfo> stsList) {
