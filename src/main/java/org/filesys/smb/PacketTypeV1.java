...
/**
 * SMB V1 Packet Types Class
 *
 * <p>Contains definitions of the available SMB V1 request types, plus SMB transaction/transaction2 request types, remote admin protocol (RAP)
...
public class PacketTypeV1 {
    ...
    /**
     * Return an SMB V1 command as a string
     *
     * @param cmd int
     * @return String
     */
